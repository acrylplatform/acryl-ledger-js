const { AcrylLedger } = require('../lib/AcrylLedger');
...
const ledger = new AcrylLedger(true);
...
function drawUsers() {
    ...
    appData.users.forEach((user) => {
        ...
        <p class="user-item" user-id="${user.id}">
            ...
            <span class="user-title">Address: </span><code class="user-data address">${user.acrylAddress}</code> 
